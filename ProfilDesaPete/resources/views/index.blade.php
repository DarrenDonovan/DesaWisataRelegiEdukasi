                ...
                <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            ...
                            <div class="carousel-caption">
                                <div class="p-3" style="max-width: 900px;">
                                    ...
                                    <h1 class="display-2 text-capitalize text-white mb-4">Website Desa Pete</h1>
                                    <p class="mb-5 fs-5">Sumber informasi terbaru tentang pemerintahan di Desa Pete 
                                    </p>
                        ...
                        <div class="carousel-item">
                            ...
                            <div class="carousel-caption">
                                <div class="p-3" style="max-width: 900px;">
                                    <h4 class="text-white text-uppercase fw-bold mb-4" style="letter-spacing: 3px;">Kegiatan di Desa Pete</h4>
                                    <h1 class="display-2 text-capitalize text-white mb-4">Kunjungan Dari Ketua T.P PKK Pusat</h1>
                        ...
                        <div class="carousel-item">
                            ...
                            <div class="carousel-caption">
                                <div class="p-3" style="max-width: 900px;">
                                    <h4 class="text-white text-uppercase fw-bold mb-4" style="letter-spacing: 3px;">Penghargaan</h4>
                                    <h1 class="display-2 text-capitalize text-white mb-4">Kampung Iklim</h1>
                                    <p class="mb-5 fs-5">Program Kampung Iklim (Proklim) dari Kementerian Lingkungan Hidup dan Kehutanan RI di Tahun 2023 
                                    </p>
                                    <div class="d-flex align-items-center justify-content-center">
                                        <a class="btn-hover-bg btn btn-primary rounded-pill text-white py-3 px-5" href="#">Discover Now</a>
                                    </div>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-item d-flex flex-column">
                            ...
                            <a href="services.html" class="nav-item nav-link">Infografis</a>
